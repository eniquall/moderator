...
class EMongoDB extends CApplicationComponent
{
	...
	public function getConnection()
	{
		if($this->_mongoConnection === null)
		{
			try
			{
                ...
                Yii::beginProfile('YMDS.getConnection');
                ...
                Yii::endProfile('YMDS.getConnection');
	...
	public function getDbInstance()
	{
		if ($this->_mongoDb === null) {
			$this->_mongoDb = $this->getConnection()->selectDB($this->dbName);
		}
